--study this when you can, what it does is reset a delayed timer if lots of events happen quickly in a row
--for example if you mash a button down, but that button is supposed to delay its reaction by 2 seconds

--it stores all the even handles somewhere, binds them to an event identifier and then calls a 
--cancel function on the event identifier to cancel all the timers
--the identifier is named 'tag', it is ergonomic part of the enhancement
